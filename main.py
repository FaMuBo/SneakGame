...
Difficulty = input("Enter the  difficulties(10-25-40-60-120): ")
...
def game_over():
    ...
    game_over_surface = my_font.render('YOU DIED', True, blue)
    game_over_rect = game_over_surface.get_rect()
    game_over_rect.midtop = (display_width/2, display_height/4)
    gameDisplay.fill(black)
    gameDisplay.blit(GameOverImg, (460, 300))
...
def show_score(choice, color, font, size):
    ...
    if choice == 1:
        score_rect.midtop = (display_width/10, 15)
    else:
        score_rect.midtop = (display_width/2, display_height/1.25)
...
while True:
    ...
    # Snake food
    pygame.draw.rect(gameDisplay, white, pygame.Rect(food_pos[0], food_pos[1], 10, 10))

    # Game Over conditions
    # Getting out of bounds
    if snake_pos[0] < 0 or snake_pos[0] > display_width-10:
        game_over()
    if snake_pos[1] < 0 or snake_pos[1] > display_height-10:
        game_over()
